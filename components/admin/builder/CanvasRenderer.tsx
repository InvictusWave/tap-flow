...
export default function CanvasRenderer({
  ...
  useEffect(() => {
    ...
    QRCode.toString(targetUrl, {
      ...
      .then((svgStr) => {
        if (isMounted) setQrSvg(svgStr.replace(/#000001/ig, 'currentColor'));
      })
      .catch(console.error);
          ...
          >
            ...
            {qrSvg ? (
              <div className="w-full h-full relative">
                <div 
                  className="w-full h-full object-contain pointer-events-none flex items-center justify-center [&>svg]:w-full [&>svg]:h-full"
